...
- (void)awakeFromNib {
    ...
    self.nameBtnImageViewLeft.constant = 13 *ProportionAdapter;
    ...
    self.eagleLableRight.constant = 15 *ProportionAdapter;
    ...
    self.birdleLableRight.constant = 15 *ProportionAdapter;
    ...
    self.parLableRight.constant = 15 *ProportionAdapter;
