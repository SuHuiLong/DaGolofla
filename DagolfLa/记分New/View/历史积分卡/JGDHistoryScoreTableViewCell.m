//
//  JGDHistoryScoreTableViewCell.m
//  DagolfLa
//
...
@interface JGDHistoryScoreTableViewCell ()
...
@implementation JGDHistoryScoreTableViewCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        UIImageView *imageV = [[UIImageView alloc] initWithFrame:CGRectMake(82 * ProportionAdapter, 35 * ProportionAdapter, 18 * ProportionAdapter, 18 * ProportionAdapter)];
...
//        self.unfinishimageV.image = [UIImage imageNamed:@"weiwanchegn"];
        ...
        self.ballName = [[UILabel alloc] initWithFrame:CGRectMake(20 * ProportionAdapter, 35 * ProportionAdapter, 170 * ProportionAdapter, 25 * ProportionAdapter)];
