...
-(void)initView
{
    ...
    viewScrollTop.scrollEnabled = NO;
...
-(void)generate
{
    ...
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|[viewTop(==tabHeight)]-verticalDistance-[viewMain]|" options:0 metrics:@{@"tabHeight":@(tabHeight),@"verticalDistance":@(0)} views:NSDictionaryOfVariableBindings(viewTop,viewMain)]];
    //////NSLog(@"%f",verticalDistance);
