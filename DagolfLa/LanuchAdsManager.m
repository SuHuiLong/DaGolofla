...
- (void)showImageOnView:(UIView *)container forTime:(NSTimeInterval)time
{
    ...
    gifImageView.image = [UIImage sd_animatedGIFNamed:@"gifLa"];
    self.conn = nil;
...
-(void)changeTitle{
    self.count--;
    self.label.text=[NSString stringWithFormat:@"%td秒",self.count];
//    if (self.count==0) {
