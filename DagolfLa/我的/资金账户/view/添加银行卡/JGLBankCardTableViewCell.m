...
//        _viewBack.backgroundColor = [UITool colorWithHexString:@"#408f73" alpha:1];
        ...
        _iconImg = [[UIImageView alloc]initWithFrame:CGRectMake(20*screenWidth/375, 30*screenWidth/375, 37*screenWidth/375, 24*screenWidth/375)];
        [_viewBack addSubview:_iconImg];
        [_iconImg setImage:[UIImage imageNamed:@"ico_bank"]];
        ...
        _titleName.textColor = [UIColor colorWithHexString:@"#58595A"];
        ...
        _stateLabel.textColor = [UIColor colorWithHexString:@"#58595A"];
        [_viewBack addSubview:_stateLabel];
        _stateLabel.text = @"储蓄卡";
        
        _deleteBtn = [UIButton buttonWithType:UIButtonTypeSystem];
        _deleteBtn.frame = CGRectMake(270*screenWidth/375, 20*screenWidth/375, 80*screenWidth/375, 44*screenWidth/375);
        ...
        _deleteBtn.tintColor = [UIColor lightGrayColor];
        
        
        _numLabel = [[UILabel alloc]initWithFrame:CGRectMake(15*screenWidth/375, 90*screenWidth/375, screenWidth - 140*screenWidth/375, 44*screenWidth/375)];
        _numLabel.textColor = [UIColor colorWithHexString:@"#F80701"];
        _numLabel.font = [UIFont systemFontOfSize:23*screenWidth/375];
...
//    _viewBack.backgroundColor = [UITool colorWithHexString:arrColor[[model.cardType integerValue]-1] alpha:1];
    ...
    if (![Helper isBlankString:model.cardName]) {
        _stateLabel.text = model.cardName;
    }
    else{
        _stateLabel.text = @"";
    }
