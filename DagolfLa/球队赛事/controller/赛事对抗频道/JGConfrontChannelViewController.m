...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    // 我的赛事
    self.myMatchBtn = [[UIButton alloc] initWithFrame:CGRectMake(15 * ProportionAdapter, 0 * ProportionAdapter, 150 * ProportionAdapter, 50 * ProportionAdapter)];
//    [self.myMatchBtn setImage:[UIImage imageNamed:@"hotfight"] forState:(UIControlStateNormal)];
    [self.myMatchBtn setTitle:@"热门对抗赛" forState:(UIControlStateNormal)];
    ...
    // 热门赛事
    self.hotMatchBtn = [[UIButton alloc] initWithFrame:CGRectMake(200 * ProportionAdapter, 0 * ProportionAdapter, 150 * ProportionAdapter, 50 * ProportionAdapter)];
//    [self.hotMatchBtn setImage:[UIImage imageNamed:@"minefight"] forState:(UIControlStateNormal)];
    [self.hotMatchBtn setTitle:@"我的对抗赛" forState:(UIControlStateNormal)];
