...
-(void)createView{
    ...
    //球员类型
    _playerType = [Factory createLabelWithFrame:CGRectMake(_almostLabel.x_width, 0, screenWidth - _almostLabel.x_width - kWvertical(19), kHvertical(51)) textColor:RGB(243,152,0) fontSize:kHorizontal(14) Title:nil];
    [_playerType setTextAlignment:NSTextAlignmentRight];
    [self.contentView addSubview:_playerType];
    //球员手机号
    _phoneLabel = [Factory createLabelWithFrame:CGRectMake(screenWidth - kWvertical(170), 0, kWvertical(98), kHvertical(50)) textColor:RGB(160,160,160) fontSize:kHorizontal(14) Title:nil];
