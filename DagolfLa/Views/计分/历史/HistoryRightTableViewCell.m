...
#import "UITool.h"
@implementation HistoryRightTableViewCell
...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _viewHen = [[UIView alloc]initWithFrame:CGRectMake(ScreenWidth/2, 80*ScreenWidth/375/2-0.5*ScreenWidth/375, ScreenWidth/2-141*ScreenWidth/375, 1*ScreenWidth/375)];
        _viewHen.backgroundColor = [UIColor lightGrayColor];
        [self.contentView addSubview:_viewHen];
        
        _baseView = [[UIView alloc]initWithFrame:CGRectMake(234*ScreenWidth/375, 8*ScreenWidth/375, 133*ScreenWidth/375, 63*ScreenWidth/375)];
