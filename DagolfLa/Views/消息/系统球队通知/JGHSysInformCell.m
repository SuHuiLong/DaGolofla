...
//        [self addSubview:self.read];
        ...
        self.time = [[UILabel alloc]initWithFrame:CGRectMake(screenWidth -100 *ProportionAdapter, 15 *ProportionAdapter, 80 *ProportionAdapter, 20 *ProportionAdapter)];
...
- (void)configJGHSysInformCell:(JGHInformModel *)model{
    ...
    self.time.frame = CGRectMake(screenWidth -100 *ProportionAdapter, titleSize.height +contentSize.height + (30 +10)*ProportionAdapter, 80 *ProportionAdapter, 20 *ProportionAdapter);
