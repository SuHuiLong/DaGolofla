...
@implementation MyFootBodyTableViewCell
...
-(void)createView
{
    _viewShu = [[UIView alloc]initWithFrame:CGRectMake(7*ScreenWidth/320, 0, 2*ScreenWidth/320, 85*ScreenWidth/320)];
