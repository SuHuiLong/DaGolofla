...
@implementation RewardArravelTableViewCell
...
-(void)agreeBtnClick
{
    ...
    [dict setValue:_ballId forKey:@"aboutBallReId"];
    ...
    [dict setValue:_userId forKey:@"userIds"];
    [dict setObject:_userId forKey:@"uid"];
    [dict setObject:@0 forKey:@"send"];
    [[PostDataRequest sharedInstance] postDataRequest:@"aboutBallRewardJoin/update.do" parameter:dict success:^(id respondsData) {
