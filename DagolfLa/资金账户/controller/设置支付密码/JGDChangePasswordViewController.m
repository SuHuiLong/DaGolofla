...
- (void)comitBtnClick{
    ...
    [[JsonHttp jsonHttp]httpRequest:[NSString stringWithFormat:@"user/updatePayPassWord?md5=%@",str] JsonKey:nil withData:dict requestMethod:@"POST" failedBlock:^(id errType) {
