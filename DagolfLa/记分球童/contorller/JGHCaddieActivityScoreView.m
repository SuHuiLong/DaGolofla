...
@interface JGHCaddieActivityScoreView ()<UITableViewDelegate,UITableViewDataSource>
{
...
-(void)getUserInfo
{
    ...
    [[JsonHttp jsonHttp]httpRequest:@"team/getTeamActivity" JsonKey:nil withData:dict requestMethod:@"GET" failedBlock:^(id errType) {
        ...
        if ([[data objectForKey:@"packSuccess"] integerValue] == 1) {
            ...
            _userNamePlayer = model.userName;
