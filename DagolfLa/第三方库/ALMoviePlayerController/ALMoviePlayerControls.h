...
@protocol ALMoviePlayerAutorotateDelegate <NSObject>
...
@property (nonatomic, strong) ALButton *playPauseButton;//播放 或者 暂停

@property (nonatomic, assign) id <ALMoviePlayerAutorotateDelegate> AutorotateDelegate;
...
/**
 The title of the control bars.
 Default value is “标题”.
 */
@property (nonatomic, strong) NSString *videoTitles;
