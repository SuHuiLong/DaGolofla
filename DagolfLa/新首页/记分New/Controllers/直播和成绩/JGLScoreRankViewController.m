...
-(void)uiConfig
{
    _tableView = [[UITableView alloc]initWithFrame:CGRectMake(0, 0, screenWidth, screenHeight - 52 * ProportionAdapter) style:UITableViewStylePlain];
...
- (void)downLoadData:(int)page isReshing:(BOOL)isReshing{
    ...
    [[JsonHttp jsonHttp]httpRequest:@"score/getReleasePolenumberRanking" JsonKey:nil withData:dict requestMethod:@"GET" failedBlock:^(id errType) {
        ...
        if ([[data objectForKey:@"packSuccess"] boolValue]) {
            ...
            if (![Helper isBlankString:[data objectForKey:@"teamName"]]) {
