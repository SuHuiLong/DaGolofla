...
@interface SearchWithMapViewController ()<BMKMapViewDelegate,BMKLocationServiceDelegate,BMKGeoCodeSearchDelegate>{
    //MapView
    BMKMapView* _mapView;
    //定位
...
-(void)initProvinceData{
    ...
    [[JsonHttp jsonHttp] httpRequest:@"bookball/getBookProvinceStatistics" JsonKey:nil withData:dict requestMethod:@"GET" failedBlock:^(id errType) {
