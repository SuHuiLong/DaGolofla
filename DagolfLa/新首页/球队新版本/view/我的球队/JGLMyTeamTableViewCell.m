...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        self.iconImageV = [[UIImageView alloc] initWithFrame:CGRectMake(10 , kWvertical(5), kWvertical(69), kHvertical(69))];
        ...
        self.nameLabel = [[UILabel alloc] initWithFrame:CGRectMake(self.iconImageV.x_width + kWvertical(10), kHvertical(11), screenWidth - self.iconImageV.x_width - kWvertical(39), 20 * screenWidth / 320)];
        self.nameLabel.font = [UIFont systemFontOfSize:15 * screenWidth / 320];
        self.nameLabel.textColor = RGB(49,49,49);
        [self.contentView addSubview:self.nameLabel];
        
        UIImageView *imageV = [[UIImageView alloc] initWithFrame:CGRectMake(self.nameLabel.x, kHvertical(40), 12 * screenWidth / 320, 12 * screenWidth / 320)];
        imageV.image = [UIImage imageNamed:@"juli"];
        imageV.contentMode = UIViewContentModeScaleAspectFit;
        [self addSubview:imageV];
        
        self.adressLabel = [[UILabel alloc] initWithFrame:CGRectMake(imageV.x_width + kWvertical(10), kHvertical(35), screenWidth - imageV.x_width - kWvertical(40), 20 * screenWidth / 320)];
        ...
        self.describLabel = [[UILabel alloc] initWithFrame:CGRectMake(self.nameLabel.x, kHvertical(55), self.nameLabel.width, 20 * screenWidth / 320)];
