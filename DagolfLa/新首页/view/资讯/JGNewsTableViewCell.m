...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        UILabel *lineLB = [self lablerect:CGRectMake(10 * ProportionAdapter, 79.5 * ProportionAdapter, screenWidth - 10 * ProportionAdapter, 0.5 * ProportionAdapter) labelColor:[UIColor colorWithHexString:@"#e5e5e5"] labelFont:0 text:@"" textAlignment:(NSTextAlignmentLeft)];
