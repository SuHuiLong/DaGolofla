...
- (void)commitBtnClick{
    ...
    [dict setObject:TYPE_CERT forKey:@"nType"];
    [dict setObject:PHOTO_DAGOLFLA forKey:@"tag"];
    // 上传头像
    [[JsonHttp jsonHttp]httpRequestImageOrVedio:@"1" withData:dict andDataArray:[_dictPhoto objectForKey:@"picHeadURL"] failedBlock:^(id errType) {
        ...
        // 上传证件照
        [[JsonHttp jsonHttp]httpRequestImageOrVedio:@"1" withData:dict andDataArray:[_dictPhoto objectForKey:@"picCertURLs"] failedBlock:^(id errType) {
