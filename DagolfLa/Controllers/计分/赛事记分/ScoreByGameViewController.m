...
@interface ScoreByGameViewController ()<UITableViewDataSource,UITableViewDelegate,UIScrollViewDelegate,CustomIOSAlertViewDelegate,UITextFieldDelegate>
{
...
@implementation ScoreByGameViewController
        ...
        [[PostDataRequest sharedInstance] postDataRequest:@"score/getIntheAct.do" parameter:@{@"userId":[[NSUserDefaults standardUserDefaults] objectForKey:@"userId"]} success:^(id respondsData) {
            ...
            if ([[dict objectForKey:@"success"] integerValue]==1) {
                ...
                else
                {
                    ...
                    _textTitle.placeholder = @"请输入赛事标题";
