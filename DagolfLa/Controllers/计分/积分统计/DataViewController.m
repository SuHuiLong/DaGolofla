...
- (void)viewDidLoad {
    ...
    //右边按钮
    UIBarButtonItem* shareBtn = [[UIBarButtonItem alloc]initWithTitle:@"分享" style:UIBarButtonItemStylePlain target:self action:@selector(shareStatisticsDataClick)];
    ...
    NSString* strUrl = @"http://www.dagolfla.com:8081/dagaoerfu/html5/team/Statistic.html";
    NSString* strMobile = [[NSUserDefaults standardUserDefaults] objectForKey:@"mobile"];
    NSURL* url = [NSURL URLWithString:[NSString stringWithFormat:@"%@?mobile=%@",strUrl,strMobile]];
    //设置页面禁止滚动
...
-(void)shareInfo:(NSInteger)index
{
    ...
    NSString*  shareUrl = [NSString stringWithFormat:@"http://www.dagolfla.com:8081/dagaoerfu/html5/team/Statistic.html?mobile=%@",[[NSUserDefaults standardUserDefaults] objectForKey:@"mobile"]];
