...
@interface SpeciallOfferViewController ()<UIWebViewDelegate>
...
@implementation SpeciallOfferViewController
...
//        NSDictionary* dict = [NSJSONSerialization JSONObjectWithData:respondsData options:NSJSONReadingMutableContainers error:nil];
        ...
        NSURL* url = [NSURL URLWithString:@"http://www.dagolfla.com/app/DailySpecial-Scroll.html"];
        //    NSURL* url = [NSURL URLWithString:@"http://www.dagolfla.com/app/DailySpecial-Scroll.html"];
        //设置web占满屏幕
