...
@interface TeamPhotoAddViewController ()<UIActionSheetDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,ZYQAssetPickerControllerDelegate,UIScrollViewDelegate,UIPickerViewAccessibilityDelegate>
{
...
@implementation TeamPhotoAddViewController
...
-(void)fabuClick:(UIButton *)btn
{
    ...
    [_dict setValue:_groupId forKey:@"photoGroupIds"];
    ////NSLog(@"%@",_groupId);
    [[PostDataRequest sharedInstance] postDataAndImageRequest:@"photos/savePhoto.do" parameter:_dict imageDataArr:_selectImages success:^(id respondsData) {
...
- (void)imageButtonPressed:(UIButton *)sender {
    ...
    __weak TeamPhotoAddViewController *weakSelf = self;
