...
//    self.view.backgroundColor = [UIColor lightGrayColor];
    ...
    for (int i = 0; i < 3; i ++) {
        ...
        button.frame = CGRectMake(0, 135 + i * 35, screenWidth, 30);
        button.tag = 200 + i;
...
//        button.titleEdgeInsets = UIEdgeInsetsMake(0, 0, 0, 100);
    ...
    self.tableView = [[JGTeamChannelTableView alloc] initWithFrame:CGRectMake(0, 270, screenWidth, screenHeight - 270 - 64) style:(UITableViewStylePlain)];
    self.tableView.delegate = self;
    self.tableView.dataSource = self;
    self.tableView.rowHeight = 83;
//    self.dataArray = [NSMutableArray arrayWithObjects:@"1我的球队", @"1球队活动", @"1球队大厅", nil];
    self.dataArray = [NSMutableArray arrayWithCapacity:0];
    UILabel *titleLB = [[UILabel alloc] initWithFrame:CGRectMake(0, 240, screenWidth, 30)];
