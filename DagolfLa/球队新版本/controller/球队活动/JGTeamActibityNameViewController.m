...
- (void)getTeamActivityResults:(UIButton *)btn{
    ...
    wkVC.detailString = [NSString stringWithFormat:@"http://imgcache.dagolfla.com/share/score/scoreRanking.html?teamKey=%td&userKey=%@&srcType=1&srcKey=%td", _teamKey,DEFAULF_USERID, timeKey];
    wkVC.teamName = @"活动成绩";
